...
ex3 :: [Int] -> [Int]
multiplier = (* (-1))
ex3 list1 = map multiplier list1
...
ex5 :: [Int] -> [Int] -> [Int]
ex5 list1 list2 = zipWith (+) list1 list2
...
ex6 :: [Int] -> [Int] -> [Int]
ex6 list1 list2 = zipWith (*) list1 list2
...
ex7 :: [Int] -> [Int] -> Int
ex7 list1 list2 = sum(zipWith (*) list1 list2)
